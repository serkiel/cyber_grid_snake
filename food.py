...
import random
import time
from config import GRID_WIDTH, GRID_HEIGHT, FOOD_COLOR
...
class Food:
    ...
    def pulse(self) -> float:
        ...
        Used by the renderer to create a pulsing glow effect on the
        food cell.  Completes one full cycle every ~1.2 seconds.
        """
